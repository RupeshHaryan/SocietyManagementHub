                ...
                <div class= "paycontainer">
                    ...
                    <form action="#" method="POST">
                        <div class="payform">
                            ...
                            <input type="text" class="field" name="pamount" placeholder=" Amount "  required><br>
                            <img src="Images/ap.png" alt="Image" width="350">
                            <input type="text" class="field" name="Tid" placeholder=" Transaction Id "  required><br>
...
if(isset($_POST['ppaymnet'])){
    ...
    $query = "insert into payrecords values(null,'$_POST[ptitle]','$_POST[pflat]','$_POST[pamount]','$_POST[Tid]','Success')";
